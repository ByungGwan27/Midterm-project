	...
	<div class="container">
		<div class="row" style="justify-content: center;">
			...
			<div style="margin: 10px;">
				...
				<table border="1">
					<tr>
						<td colspan="2"><h3>상호명 : ${hotelInfo.hotelName}
								${hotelInfo.hotelId}</h3></td>

						<td rowspan="5">
							<!-- 지도를 표시할 div 입니다 -->
							<div id="map" style="width: 500px; height: 400px;"></div> <script
								type="text/javascript"
								src="//dapi.kakao.com/v2/maps/sdk.js?appkey=3006275e89e032554f54989c83ebea8d"></script>
							<script>
	...
	<div class="container">
		...
		<div class="row"
			...
			<c:forEach var="similarList" items="${similarList}">
				<div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
					<div class="media-1">
						<a href="hotelInfoPage.do?hotelId=${similarList.hotelId}"
							...
							<div>
								...
								<div class="price ml-auto">
									<span class="icon-room mr-3"></span><span>${similarList.hotelLocation1}
										...
										${similarList.roomPrice}</span> <br>
									<span><a
										href="hotelInfoPage.do?hotelId=${similarList.hotelId}"><button>예약</button></a></span>
								</div>
							</div>
						</div>
					</div>
