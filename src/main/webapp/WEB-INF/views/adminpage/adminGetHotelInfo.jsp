	...
	<form action="adminHotelInfoModifyPage.do" method="GET">
		<table class="table">
			...
			<tr>
				<th>시설정보</th>
				<td>
					<span class="fa fa-chevron-right mr-2"><input type="checkbox">주차장</span>
					<span class="fa fa-chevron-right mr-2"><input type="checkbox">wifi</span>
					<span class="fa fa-chevron-right mr-2"><input type="checkbox">애완동물동반가능여부</span>
					<span class="fa fa-chevron-right mr-2"> <input type="checkbox">조식 </span>
					<span class="fa fa-chevron-right mr-2"><input type="checkbox">수영장</span>
				</td>
			</tr>
		<tr>
		<td><h5>객실정보확인</h5></td>
