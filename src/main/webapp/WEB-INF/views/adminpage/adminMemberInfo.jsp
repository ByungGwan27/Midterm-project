          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">회원 수정</button>
                </li>
 ...
 -->
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">회원 아이디</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">회원 비밀번호</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="Kevin Anderson">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <label for="Twitter" class="col-md-4 col-lg-3 col-form-label">가입 날짜</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      <label for="Facebook" class="col-md-4 col-lg-3 col-form-label">회원 등급</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-primary">회원 수정</button>
                       <button type="submit" class="btn btn-primary">회원 삭제</button>
                    </div>
